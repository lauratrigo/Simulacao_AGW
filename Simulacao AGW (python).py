...
# =============================================================================#
def salvar_keograma(x, y, dados, titulo, nome_arquivo, xlabel="Tempo (s)", ylabel="Longitude/Latitude"):
    """Salva um keograma a partir dos dados"""
    ...
    im = plt.pcolormesh(x, y, dados, cmap='seismic', shading='auto')
    plt.colorbar(im)
    plt.xlabel(xlabel)
    plt.ylabel(ylabel)
    plt.title(titulo)
