...
class GEOSTIDSSimulator:
    ...
    def _build_source(self) -> Source:
        ...
        amplitude_factor = 1000  # Mude este valor: 1, 10, 50, 100, 500
    ...
    def step(self, i_t: int) -> dict:
        ...
        if self.cfg.source_type == "seismic":
            ...
            # Calcula amplitude sísmica no tempo atual
            ...
            # Fator de escala para amplitudes físicas (ajuste conforme necessário)
